...
"""
s11_autonomous_agents.py - Autonomous Agents (OpenRouter version)

Idle cycle with task board polling, auto-claiming unclaimed tasks, and
identity re-injection after context compression. Builds on s10's protocols.

    Teammate lifecycle:
    spawn -> WORK (agent loop) -> IDLE (poll inbox + task board) -> WORK ...
    IDLE timeout (60s) -> shutdown
...
# -- Autonomous TeammateManager (OpenRouter) --
            ...
            for _ in range(polls):
                ...
                if unclaimed:
                    ...
                    if len(messages) <= 3:
                        ...
                        messages.insert(
                            1, {"role": "assistant", "content": f"I am {name}."}
                        )
    ...
    def _teammate_tools(self) -> list:
        return [
            ...
            },
            {
                ...
                "function": {
                    "name": "idle",
                    "description": "Signal no more work. Enters idle polling.",
                    "parameters": {"type": "object", "properties": {}},
                },
            },
            {
...
TOOL_HANDLERS = {
    ...
    "plan_review": lambda **kw: handle_plan_review(
