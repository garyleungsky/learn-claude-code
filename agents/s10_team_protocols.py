...
"""
s10_team_protocols.py - Team Protocols (OpenRouter version)
...
# -- TeammateManager with shutdown + plan approval (OpenRouter) --
...
TOOL_HANDLERS = {
    ...
    "check_shutdown": lambda **kw: _check_shutdown_status(kw["request_id"]),
...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Request a teammate to shut down. Returns request_id.",
            "parameters": {
                "type": "object",
