...
"""
s12_worktree_task_isolation.py - Worktree + Task Isolation (OpenRouter version)
...
class EventBus:
    ...
    def emit(
        self, event: str, task: dict = None, worktree: dict = None, error: str = None
    ):
        payload = {
            "event": event,
            "ts": time.time(),
...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Bind a task to a worktree.",
            "parameters": {
                "type": "object",
                "properties": {
                    "task_id": {"type": "integer"},
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Remove a worktree, optionally completing its task.",
            "parameters": {
                "type": "object",
                "properties": {
                    "name": {"type": "string"},
